...
description: "Stop wiring a separate provider, key and OAuth flow for every model in Hermes Agent. Point Hermes at one OpenAI-compatible gateway and switch between <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models from the /model picker."
keywords:
...
…56 curated entries (<!-- br:models.chatVisible@live -->79<!-- /br:models.chatVisible@live --> models via the gateway)
```
...
<!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> across OpenAI, Anthropic, Google, DeepSeek, Moonshot/Kimi, xAI/Grok, MiniMax,
...
billing and <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models behind the one URL.*
