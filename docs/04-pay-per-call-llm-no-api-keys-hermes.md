...
description: "Funding and rotating an API key for every model your Hermes agent uses is a chore and a liability. Here's how to give Hermes keyless, pay-per-call access to <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models with USDC micropayments from a wallet you control."
keywords:
...
call and routes to <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models:
