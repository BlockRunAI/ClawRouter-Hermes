...
<strong>One Hermes provider, <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models from 12 labs, paid per request —<br>
...
| ------------------- | --------------------------- | ------------------- | ------------------ | --------------------------------------------------------------------- |
| **Models**          | One provider block per lab  | Many                | Whatever you host  | **<!-- br:models.chatVisible -->79<!-- /br:models.chatVisible -->, one block**            |
...
The `/model` picker carries a curated, provider-grouped slice of the catalog (small inline keyboards can't render <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> entries); every other model stays routable by full ID.
...
| Tool                        | Coverage                                                                                  |
| --------------------------- | ----------------------------------------------------------------------------------------- |
| `clawrouter_image_generate` | <!-- br:models.image -->12<!-- /br:models.image --> image models — GPT Image 2, Nano Banana / Pro, Seedream 5 Pro, Grok Imagine, CogView-4 |
...
You're here. <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models, smart routing, wallet or API key.
...
Claude Code on <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models — no Anthropic account, no rate limits, pay per request.
